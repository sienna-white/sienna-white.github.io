---
layout: single
title: "CV (text backup)"
permalink: /cv-text/
author_profile: true
excerpt: "A plain-text/Markdown copy of the CV content, kept for reference. Not linked in the site navigation."
---

<p style="font-size: 0.85em; color: #888;">
  This page isn't linked from the site menu. It's a backup of the Markdown CV content that used to live at <code>/cv/</code>, kept here in case any of the wording is useful when building out the PDF version. Feel free to delete this page once you no longer need it.
</p>
